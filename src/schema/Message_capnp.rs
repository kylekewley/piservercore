...
// DO NOT EDIT.
// source: src/schema/Message.capnp
...
pub mod message {
  ...
  impl <'a> Reader<'a> {
    ...
    #[inline]
    pub fn get_recv_ack(self) -> bool {
      self.reader.get_bool_field_mask(96, true)
    }
    #[inline]
    pub fn get_message(self) -> ::capnp::any_pointer::Reader<'a> {
  ...
  impl <'a> Builder<'a> {
    ...
    #[inline]
    pub fn set_parser_id(&mut self, value : u32)  {
      self.builder.set_data_field::<u32>(2, value);
    }
    #[inline]
    pub fn get_recv_ack(self) -> bool {
      self.builder.get_bool_field_mask(96, true)
    }
    #[inline]
    pub fn set_recv_ack(&mut self, value : bool)  {
      self.builder.set_bool_field_mask(96, value, true);
    }
    #[inline]
    pub fn get_message(self) -> ::capnp::any_pointer::Builder<'a> {
      ::capnp::any_pointer::Builder::new(self.builder.get_pointer_field(0))
    }
    #[inline]
    pub fn init_message(self, ) -> ::capnp::any_pointer::Builder<'a> {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xb75574a29c06ac00;
  }
}
