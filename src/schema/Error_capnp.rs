...
pub mod error {
  ...
  impl <'a> Reader<'a> {
    ...
    #[inline]
    pub fn get_message(self) -> Result<text::Reader<'a>> {
  ...
  impl <'a> Builder<'a> {
    ...
    #[inline]
    pub fn get_message(self) -> Result<text::Builder<'a>> {
      self.builder.get_pointer_field(0).get_text(::std::ptr::null(), 0)
    }
    #[inline]
    pub fn set_message(&mut self, value : text::Reader)  {
      self.builder.get_pointer_field(0).set_text(value);
    }
    #[inline]
    pub fn init_message(self, size : u32) -> text::Builder<'a> {
    ...
    #[inline]
    pub fn set_blame_id(&mut self, value : u64)  {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0x9ee34dd2ef50d132;
  }
}
